				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="courses"><!--Courses-->
							...
							<div class="well">
								<ul class="nav nav-pills nav-stacked">
									<input type="radio" name="course" value="phd">P.H.D<br>
									<input type="radio" name="course" value="ms">M.S<br>
						...
						<div class="AIR"><!--AIR-->
							...
							<h2>AIR</h2>
							<div class="well">
								 <input type="radio" name="q_exam" value="gate"> Gate<br>
								 <input type="radio" name="q_exam" value="nbhm_jrf"> NBHM JRF<br>
								 <input type="radio" name="q_exam" value="ugc_jrf"> UGC JRF <br>
								 <input type="radio" name="q_exam" value="csir"> CSIR <br>
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="10000" data-slider-step="5" data-slider-value="[1,5000]" id="sl2" ><br />
								 <b>1</b> <b class="pull-right"> 100000</b>
							</div>
						</div><!--/AIR-->

						<div class="Academics"><!--Academic-->
								
							<h2>Academics</h2>
							<div class="well">
								 <input type="checkbox" name="q_10" value="10_board">10th Board<br>
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="[1,100]" id="sl3" ><br />
								 
								 <b>0</b> <b class="pull-right"> 100</b>
								 <br>
								 <input type="checkbox" name="q_12" value="12_board"> 12th Board<br>
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="[1,100]" id="sl4" ><br />
								 
								 <b>0</b> <b class="pull-right"> 100</b>
								 <br>
								 <input type="checkbox" name="q_clg" value="ugc_jrf">College <br>
								 
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="10" data-slider-step=".5" data-slider-value="[1,10]" id="sl5" ><br />
								 
								 <b>0</b> <b class="pull-right"> 10</b>
								 <br>
							</div>
						</div><!--/Academic-->
